                ...
                <div class="p-6 text-gray-900">
                    <form method="post" action="{{ route('categories.store') }}" class="mt-5 space-y-5">
                        ...
                        <div>
                            ...
                            <textarea id="description" name="description" type="text" class=" form-control mt-1 block w-full" :value="old('description')" autocomplete="new-description" required> </textarea>
                            <x-input-error :messages="$errors->get('description')" class="mt-2" />
                        </div>
                        <div>

                            <x-input-label for="is_active" :value="__('Is_active')" />
                            <input type="checkbox" name="is_active" class= "form-control" :value="old('is_active')== true ? checked" />
                        </div>
